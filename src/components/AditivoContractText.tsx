 ...
 * já assinado, sem alterar o instrumento original.
 */
...
export default function AditivoContractText({
  ...
  return (
    <article className="text-sm text-slate-700 text-justify space-y-4 leading-relaxed">
      ...
      <H>Cláusula 5ª – Da Ratificação</H>
      <p>
        5.1. Ficam ratificadas todas as demais cláusulas e condições do contrato originário que não
        conflitem com este termo aditivo, que a ele se integra para todos os fins de direito.
      </p>

      <H>Cláusula 6ª – Da Assinatura Eletrônica e do Foro</H>
      <p>
        6.1. As partes reconhecem a validade da assinatura eletrônica deste termo, nos termos da MP
        nº 2.200-2/2001 e da Lei nº 14.063/2020, com registro de data, hora, IP e dispositivo.
      </p>
      <p>
        6.2. Fica eleito o foro da comarca de São Luís - MA, com renúncia a qualquer outro.
      </p>
    </article>
  );
}
